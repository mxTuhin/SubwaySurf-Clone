...
public class Canvatbuyshop : MonoBehaviour
{
    ...
    // {
    //     MyPkgManager.GiveEarnedReward += GiveEarnedReward;
    // }
    ...
    //     switch (MyGlobalValues.rewardType)
    //     {
    //         case "skiplevel":
    //             Debug.Log("skiplevel");
    //             break;
    ...
    //         default:
    //         {
    //             if (MyGlobalValues.rewardType.Equals("unlockvehicle"))
    //                 Debug.Log("unlockvehicle");
    //             break;
    //         }
    //     }
    ...
    public void ClicBuyvan()
    {
        ...
        else
        {
            ...
            if (strcheck != "SELECT" && strcheck != "SELECTED")
            {
                ...
                if (price <= managerdata.manager.Getcoin())
                {
                    managerdata.manager.Setnowcharacter(bettent.name);
                    managerdata.manager.savecoin(-price);
                    switch (bettent.name)
                    {
                        case "nvchinh":
                            managerdata.manager.SetCharacternvchinh(1);
