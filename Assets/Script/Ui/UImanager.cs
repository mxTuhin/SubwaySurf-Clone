   ...
   // public GameObject Evensystem;
    ...
    void Start () {
       ...
       // ShowHighscor3D.text = managerdata.manager.getmuving().ToString();
        ...
        getvan = true;
        Closebox = true;
//     if(MyPkgManager.Instance.isAdmobBannerLoaded==null) 99
  //      {MyPkgManager.Instance.ShowAdmobBanner(); } 99
...
//                initadmod.instance.ShowFullNowOnOpenGame();
    ...
    public void play()
    {
       ...
       // MyPkgManager.Instance.ShowAdmobBanner();
       // AdmobManager._AdMobInstance.showBannerAd();
        // Evensystem.SetActive(false);
    }
    ...
    IEnumerator Playdelay()
    {
       ...
       // Debug.Log("chơi lại");
        ...
        //GoogleMobileAdsScript.Instance.showbaner();
//        initadmod.instance.ShowBanerOnPlayGame();
		//11AdmobManager._AdMobInstance.showBannerAd();
    ...
    public void Lost()
    {
        ...
        if (alowcall)
        {
            ...
            //11AdmobManager._AdMobInstance.showInterstitial();
...
//                initadmod.instance.HideBaner();
				//11AdmobManager._AdMobInstance.hideBannerAd();
                inthepanelpause.playagain = true;
                if (showbane >= 2)
                {
